...
```
git clone https://github.com/Rodrhi23/Llanquihue-Tour-EFT.git
```

1. Abrir el proyecto en NetBeans
2. Revisar que clientes.txt, empleados.txt y proveedores.txt esten en la raiz del proyecto (al lado del pom.xml)
3. Correr la clase Main (paquete app)
4. Deberia mostrar en consola: carga de datos, listado de todas las personas, busqueda de un cliente por rut, y las reservas guardadas
